...
{{#is_mechanism}}
    <div class="col-md-2 col-sm-2 col-xs-2">
        ...
        <option value = "dBGWKhgcfHi">AIDS Healthcare Foundation (AHF)</option>
        <option value = "SuIPMBE1tdx">AMPATH Plus</option>
        <option value = "DfQtifjJmUL">AMREF REACH90</option>
        <option value = "TPMswba5tT9">Aphia Plus HCM</option>
        <option value = "Y99IdhUBwVt">Aphia Plus Imarisha</option>
        <option value = "Fc0LqGvdsCZ">Aphia Plus Western</option>
        <option value = "kGqwKzwdW8N">Boresha maabara, UOM</option>
        <option value = "A6Tizyw5RMA">CARE International Kenya</option>
        <option value = "Lxxgxt1sgmK">CHAK-CDC HIV-AIDS Program</option>
        <option value = "yH3oqOmjeEf">CHS - Naishi</option>
        <option value = "ZsZiD7tMEME">CHS - Tegemeza Plus</option>
        <option value = "WQpmVsfVYJ0">CHS - Western Kenya</option>
        <option value = "dhOPMg5IdNS">Coptic Hospital</option>
        <option value = "d48lfxw9xH4">DREAM Kenya Trust</option>
        <option value = "Jft4an3wRFI">EDARP</option>
        <option value = "LUWM60xLxBw">EGPAF ZUIA</option>
        <option value = "TprGYJFsZJ2">EGPAF-TIMIZA90 (Homabay)</option>
        <option value = "wVSW0uQ9lOy">EGPAF-TIMIZA90 (Turkana)</option>
        <option value = "OkMcxdJzp8Q">EGPAF-TUNAWEZA</option>
        <option value = "UscRnEmcK02">FHI 360</option>
        <option value = "Pug5jelN5xz">Global Implementation Solutions (GIS)</option>
        <option value = "SKtUUEv0gV8">Healthstrat TACT programme</option>
        <option value = "L0ZHuJdHI2O">HJF Kisumu West</option>
        <option value = "rfoiP0N9lUz">HJF-Nairobi</option>
        <option value = "PA8qJa6Ugmc">HJF-South Rift Valley</option>
        <option value = "XnURqa8h0si">HOPE Worldwide</option>
        <option value = "PBXBKTzqOEB">ICAP Eastern</option>
        <option value = "SYs4h0eQ8dw">ICAP JOOTRH</option>
        <option value = "QobPrDDMzgc">IRDO-Pembetatu</option>
        <option value = "qe2XolaQP1j">KCCB-KARP</option>
        <option value = "iRFEcXxX5yb">Lea Toto Program</option>
        <option value = "aPISVO6fGXf">LVCT</option>
        <option value = "IPo5l08Oltf">Mkomani Clinic Society</option>
        <option value = "thhInJxfTgf">Nilinde,Coast</option>
        <option value = "cETYpc9oWU5">No Partner</option>
        <option value = "rQlek1MJqNR">PHASE</option>
        <option value = "vWNbMTmNoH0">Siaya MOH CoAg</option>
        <option value = "SABTpC1HIld">Speed24</option>
        <option value = "nfPEtPejOCl">TBD</option>
        <option value = "SWki4hUqE5X">UCSF - FACES</option>
        <option value = "WyN6Trkn3VP">UMB Western Kenya-Timiza</option>
        <option value = "gwZ2Tgkm3qO">University of Manitoba</option>
        <option value = "Ci2p7dNfrhH">UoMaryland-PACT Endeleza</option>
